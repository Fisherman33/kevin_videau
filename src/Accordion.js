...
class ProjectCategory extends React.Component {
    ...
    getWidth(isActive) {
        let w = !isActive ? 'calc(20vw - 20px)' : '600px'
        return w
    }
    render() {
        ...
        let styles = {
          container: { 
            transform: (function() {
                return active
                    ? 'scale(1.01) translate3d(0, 0, 500)'
                    : 'scale(0.6) translate3d(0, 0, 0)'
            })()
          }, item: {
              transform: (function() {
                  let direction = (shiftLeft) ? '-': ''
                  let transform = (focused && !active) ? 'translate3d('+ direction +'40%, 0, 0)' : 'translate3d(0, 0, 0)'
                  return transform
              })()
          }, background: {
...
class Collection extends React.Component {
    ...
    componentDidMount() {
      ...
      this.setState({
        categories: [{"thumbnail":"https://static1.squarespace.com/static/571a021020c64744b886f00f/t/5737824520c6471cf0610644/1463255625811/","link":"http://seanma.de","taxonomy":"category","count":6,"name":"HTML5 CSS3 JS"},{"thumbnail":"https://cdn.thenewstack.io/media/2016/04/nodejs.jpg","link":"http://seanma.de","taxonomy":"category","count":8,"name":"Node Js","slug":"laborum","id":"586537da60c040bc1e3060a1"},{"thumbnail":"http://toolynk.com/wp-content/uploads/2017/10/react-native-paris-et-lyon.png","link":"http://seanma.de","taxonomy":"category","count":6,"name":"React","slug":"voluptate","id":"586537dae1be34396786ce5f"},{"thumbnail":"https://pluralsight.imgix.net/paths/path-icons/angular-14a0f6532f.png","link":"http://seanma.de","taxonomy":"category","count":2,"name":"Angular","slug":"voluptate","id":"586537dab274a22da2f3edae"}]
      })
    }
